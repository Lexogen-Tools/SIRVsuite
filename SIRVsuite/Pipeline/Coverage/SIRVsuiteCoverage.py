...
class SIRVsuiteCoverage():
    ...
    ** by default, the annotation is loaded from a Resources folder in SIRVsuite project
    ...
    def coverage_plot(self):
        ...
        """
        This method utilizes CairoDrawer class to draw objects onto surface of interest. In current version, .png format of the surface is hardcoded.
        Here, all dimensions, coordinates, colors and draw elements within the surface are defined. It creates the graphical output separately for each gene and sample.    
        """
