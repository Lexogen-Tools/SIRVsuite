...
class ERCCcorrelation():
    ...
    def __init__(self, sample_sheet):
        self.read_ERCC_concentration_table()

    def read_ERCC_concentration_table(self):
    ...
    def get_data(self, file_list, file_type, sample_names):
    ...
    def ERCC_correlation(self, file_list, types, sample_names, ercc_spike_in, experiment_name = "unnamed", output_dir = "test_output/Correlation/"):
