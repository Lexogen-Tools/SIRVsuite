...
The correlation table consist of Pearson correlation R values between true and measured <a href=ttps://assets.thermofisher.com/TFS-Assets/LSG/manuals/cms_095046.txt>ERCC concentrations</a>. The correlation plot, generated by the ERCC correlation module, is a scatterplot showing the true concentration of the ERCCs on the x-axis and the measured concentration on the y-axis concentration. An example of such a correlation plot is given below.
